    ...
    Pass{
      ...
      Tags{"LightMode" = "ForwardBase"}
        ...
        float4 Frag(VertexOutput o):SV_TARGET
        {
          ...
          albedo.rgb = DiffuseAndSpecularFromMetallic(albedo.rgb, _Metallic, specularTint, OneMinusReflectivity);
          ...
          float4 color = UNITY_BRDF_PBS(albedo, specularTint, OneMinusReflectivity, _Smoothness, o.normal, viewDirection, light, indirectLight);
